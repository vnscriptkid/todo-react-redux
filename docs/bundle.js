...
var _actionCreators = __webpack_require__(/*! ./actionCreators */ "./src/actionCreators.js");
	...
	return _react2.default.createElement(
		'form',
		{
			onSubmit: function onSubmit(e) {
				e.preventDefault();
				dispatch((0, _actionCreators.addTodo)(input.value));
				input.value = '';
			}
		},
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, props) {
	return {
		onClick: function onClick() {
			return dispatch((0, _actionCreators.setFilter)(props.filter));
		}
	};
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(FilterLink);
...
var todoFilter = function todoFilter(filter, todos) {
	if (filter === 'all') {
		return todos;
	} else if (filter === 'done') {
...
var Todo = function Todo(_ref) {
	...
	return _react2.default.createElement(
		'li',
		{ style: { textDecoration: isDone ? 'line-through' : 'none' }, onClick: onClick },
		todo
	);
};
...
var TodoList = function TodoList(_ref2) {
	...
	return _react2.default.createElement(
		...
		todos.map(function (todo) {
			return _react2.default.createElement(Todo, _extends({ key: todo.id, onClick: function onClick() {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	return {
		onTodoClick: function onTodoClick(id) {
			return dispatch((0, _actionCreators.toggleTodo)(id));
		}
	};
};
...
var _TodoList = __webpack_require__(/*! ./TodoList */ "./src/TodoList.js");

var _TodoList2 = _interopRequireDefault(_TodoList);

var _AddTodo = __webpack_require__(/*! ./AddTodo */ "./src/AddTodo.js");

var _AddTodo2 = _interopRequireDefault(_AddTodo);

var _FilterLink = __webpack_require__(/*! ./FilterLink */ "./src/FilterLink.js");
...
var combineReducersCustom = function combineReducersCustom(reducerObject) {
	return function () {
		var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
		var action = arguments[1];

		return Object.keys(reducerObject).reduce(function (acc, key) {
